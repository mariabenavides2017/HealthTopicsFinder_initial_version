          ...
          <div class="col-lg-14 section-style">
   			<?php
			    if ($result->num_rows > 0) {
				   ...
				   echo '<thead><tr><th>Title</th><th>Description</th><th>Also called</th><th>Summary</th></tr></thead>';
				   echo '<tbody>';
                    while($row = $result->fetch_assoc()) {
					  echo '<tr>';
					  echo '<td><p class="text-primary"><strong>' . $row["title"] . '</strong></p></td>';
					  // echo '<td><a href="' . $row["url"] . '" target="_blank">' . $row['url'] . '</a></td>';
					  echo '<td><a href="' . 'list_common_diseases.php?wikiTerm=' . $row['title'] . '" >' . $row['title'] . '</a></td>';
